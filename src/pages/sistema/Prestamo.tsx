  ...
  if (confirmado) return (
    <div className="page-wrapper">
      <div className="page-card" style={{ textAlign: 'center' }}>
        <CheckCircleOutlined style={{ fontSize: 64, color: '#0ea5e9', marginBottom: 16 }} />
    ...
    <div className="page-wrapper">
      <div className="page-card">
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <BookOutlined style={{ fontSize: 40, color: '#0ea5e9', marginBottom: 12 }} />
          ...
          <>
            ...
            <div className="libro-resultado">
              ...
              <div className="libro-stock">
                ...
                <div className="stock-item"><span className="stock-num" style={{ color: '#0d9488' }}>{libro.disponibles}</span><span className="stock-label">Disponibles</span></div>
                <div className="stock-item"><span className="stock-num" style={{ color: '#f59e0b' }}>{libro.totalEjemplares - libro.disponibles}</span><span className="stock-label">Prestados</span></div>
              </div>
              {libro.disponibles > 0
