  ...
  return (
    <div className="landing">
      ...
      <nav className="landing-nav" id="inicio">
        ...
        <Button className="btn-admin" onClick={() => navigate('/login')} icon={<ArrowRightOutlined />}>
        ...
        <div className="hero-visual">
          <div className="blob-wrap">
            ...
            <div className="blob-card card-2">
              <BookOutlined style={{ color: '#0094A2', fontSize: 20 }} />
              <div>
        ...
        <div className="servicios-grid">
          <div className="servicio-card">
            <div className="servicio-icon servicio-icon-teal">
              <BookOutlined style={{ color: '#0094A2', fontSize: 24 }} />
            </div>
          ...
          {libros.map(libro => (
            <div key={libro.codigo} className="catalogo-card">
              ...
              <div className="catalogo-footer">
                <Statistic title="Total ejemplares" value={libro.totalEjemplares} valueStyle={{ fontSize: 20, fontWeight: 800, color: '#1E2A38' }} />
                <Statistic title="Disponibles" value={libro.disponibles} valueStyle={{ fontSize: 20, fontWeight: 800, color: '#0094A2' }} />
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="landing-section" id="horarios">
        ...
        <div className="horarios-grid">
          <div className="horario-card">
            <CalendarOutlined style={{ fontSize: 28, color: '#0094A2' }} />
        ...
        <div className="hora-actual">
          <ClockCircleOutlined style={{ marginRight: 8, color: '#0094A2' }} />
      ...
      <footer className="landing-footer" id="contacto">
        <div className="footer-content">
          ...
          <div className="footer-contacto">
            ...
            <div className="contacto-item"><PhoneOutlined style={{ color: '#0094A2' }} /><span>(593-7) 283 8323 / 284 3619 / 0996976449</span></div>
            <div className="contacto-item"><MailOutlined style={{ color: '#0094A2' }} /><span>info@sudamericano.edu.ec</span></div>
            <div className="contacto-item"><MailOutlined style={{ color: '#0094A2' }} /><span>relpublicaits@sudamericano.edu.ec</span></div>
            <div className="contacto-item"><EnvironmentOutlined style={{ color: '#0094A2' }} /><span>Simón Bolívar y Manuel Vega Esq. Cuenca EC</span></div>
            <div className="contacto-item"><EnvironmentOutlined style={{ color: '#0094A2' }} /><span>Edificio Huayna Cápac: Jaime Roldós 4-85</span></div>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <span style={{ color: '#9ca3af', fontSize: 12 }}>Biblioteca Daniel Perazzo · Cuenca, Ecuador</span>
        </div>
      </footer>
